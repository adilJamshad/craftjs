    ...
    return (
      ...
      (e.prototype.isIndicatorUpdateRequired = function (e, t) {
        ...
        return 'Footer' === t.data.displayName
          ? e.id === craftjsUtilsMeetovo.ROOT_NODE && this.currentIndicator
          ...
          : e.id === craftjsUtilsMeetovo.ROOT_NODE &&
              this.currentIndicator &&
              this.currentIndicator.placement &&
      ...
      (e.prototype.getNewIndicatorPosition = function (e, t) {
        ...
        return (
          ...
          (this.currentIndicator = {
            placement: _assign(_assign({}, { index: r, parent: o, where: n }), {
              currentNode: a,
            }),
            error: null,
          }),
      ...
      (e.prototype.computeIndicator = function (e, t, n) {
        ...
        if (
          ...
          var o = findPosition(r, this.currentTargetChildDimensions, t, n),
            a = this.store.query.node(this.currentDropTargetId).get();
          if (!this.isDiff(o))
            return this.isIndicatorUpdateRequired(r, a)
              ? this.getNewIndicatorPosition(r, a)
              : void 0;
          if (this.isIndicatorUpdateRequired(r, a))
            return this.getNewIndicatorPosition(r, a);
          if (!this.shouldUpdateIndicator(r, a)) {
            ...
            var s = r.data.nodes[o.index],
              d = s && this.store.query.node(s).get();
            return (
              (this.currentIndicator = {
                placement: _assign(_assign({}, o), { currentNode: d }),
                error: i,
              }),
              this.currentIndicator
            );
              ...
              a = e.addCraftEventListener(t, 'click', function (t) {
                ...
                a && i
                  ? (s.splice(s.indexOf(r), 1),
                    n.actions.setNodeEvent('selected', s, 'if-unbindOnClick'))
                  : !a &&
                    o.length > 1 &&
